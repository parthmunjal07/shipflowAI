...
export default async function GitHubIntegrationPage({
  ...
  return (
    <div className="flex-1 h-full bg-surface-base flex overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <div className="flex items-center gap-5">
              <div className="w-16 h-16 rounded-2xl bg-surface-elevated border border-[#27272a] flex items-center justify-center shrink-0 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              {installation ? (
                <a 
                  ...
                  target="_blank"
                  className="flex items-center gap-1.5 px-4 py-2 bg-brand-mint hover:bg-brand-mintHover text-brand-dark font-bold transition-colors text-white text-[13px] font-bold rounded-lg shadow-sm"
                >
          ...
          <div>
            ...
            <div className="bg-surface-card border border-[#27272a]/50 rounded-xl overflow-x-auto p-8 text-center text-[13px] text-[#71717a]">
...
function RepoCard({ name, branch, time, url }: { name: string, branch: string, time: string, url: string }) {
  return (
    <div className="bg-surface-card border border-[#27272a]/50 rounded-xl p-4 flex items-center justify-between">
      <div className="flex items-center gap-4">
        <div className="w-10 h-10 rounded-lg bg-brand-mint text-brand-dark font-bold/10 flex items-center justify-center shrink-0">
