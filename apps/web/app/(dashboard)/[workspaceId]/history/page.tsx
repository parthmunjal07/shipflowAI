    ...
    <div className="flex-1 h-full bg-surface-base overflow-y-auto">
      <div className="max-w-4xl mx-auto w-full p-8 lg:p-12 pb-32">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <StatCard title="REVIEW PASSES" value="3" valueColor="text-brand-mint" />
        ...
        <div className="bg-surface-card border border-[#27272a]/50 rounded-2xl p-8 mb-8 relative">
          ...
          <div className="space-y-12 relative z-10">
              ...
              <div className="flex-1">
                ...
                <div className="bg-surface-elevated rounded-xl border border-[#27272a]/50 p-6">
                  ...
                  <div className="flex items-end gap-6 h-24 mb-6 border-b border-[#27272a]/50 pb-2">
                    ...
                    <ChartGroup label="Code Quality 2" bars={[{ h: "h-10", c: "bg-[#52525b]" }, { h: "h-10", c: "bg-brand-mint text-brand-dark font-bold" }]} />
                    <ChartGroup label="PRD Mismatch 2" bars={[{ h: "h-10", c: "bg-brand-mint text-brand-dark font-bold" }, { h: "h-10", c: "bg-brand-mint text-brand-dark font-bold" }]} />
                  </div>
            ...
            {/* PASS 2 */}
            <div className="flex gap-6">
              <div className="w-3 h-3 rounded-full bg-brand-mint text-brand-dark font-bold mt-1.5 shrink-0 shadow-[0_0_8px_rgba(59,130,246,0.5)]"></div>
              <div className="flex-1">
        ...
        {/* Empty State */}
        <div className="bg-surface-card border border-[#27272a]/50 rounded-2xl p-8 flex items-start gap-4">
          ...
          <div>
            ...
            <a href="#" className="text-[13px] font-medium text-brand-mint hover:text-brand-mint transition-colors">
              View PR on GitHub →
            </a>
          </div>
        </div>
