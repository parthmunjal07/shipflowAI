...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <DirtyStateProvider>
      <div className="min-h-screen flex bg-[#0A0D14] text-white font-[family-name:var(--font-geist-sans)] selection:bg-blue-500/30">

        {/* Left Sidebar */}
        <aside className="w-[260px] flex-shrink-0 flex flex-col border-r border-[#27272a]/50 bg-[#0A0D14]">
          {/* Logo */}
          <div className="h-[88px] flex items-center px-6 gap-3">
            <div className="w-10 h-10 rounded-xl bg-blue-600/10 text-blue-500 flex items-center justify-center font-bold text-[14px] shadow-sm">
