...
export function WorkspaceSwitcher() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-[240px] bg-surface-card border border-[#27272a]/50 rounded-xl shadow-2xl overflow-hidden z-40 animate-in fade-in slide-in-from-top-2 duration-150">
          <div className="p-2">
          ...
          <div className="p-2 border-t border-[#27272a]/50 bg-surface-base/50">
            <button
              onClick={() => {
                setIsOpen(false);
                setIsCreateModalOpen(true);
              }}
              className="w-full flex items-center gap-2 px-2 py-2 rounded-lg text-sm text-brand-mint hover:bg-brand-mint/10 transition-colors font-medium"
            >
      ...
      {isCreateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-surface-card border border-[#27272a]/50 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center gap-3 p-6 border-b border-[#27272a]/50">
              <div className="w-10 h-10 rounded-xl bg-brand-mint text-brand-dark font-bold/10 text-brand-mint flex items-center justify-center">
            ...
            <form onSubmit={handleCreate} className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-surface-base border border-[#27272a]/50 rounded-lg px-4 py-2.5 text-[14px] text-white placeholder-[#71717a] focus:outline-none focus:border-blue-500 transition-colors"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className="w-full bg-surface-base border border-[#27272a]/50 rounded-r-lg px-4 py-2.5 text-[14px] text-white placeholder-[#71717a] focus:outline-none focus:border-blue-500 transition-colors"
                    required
                  />
                </div>
              ...
              <div className="pt-2 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-lg bg-brand-mint hover:bg-brand-mintHover text-brand-dark font-bold disabled:opacity-50 disabled:cursor-not-allowed text-white text-[14px] font-medium transition-colors flex items-center gap-2"
                >
